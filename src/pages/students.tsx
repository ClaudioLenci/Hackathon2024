      ...
      <div className="font-Noto text-primary-charcoal">
        ...
        <section className="py-12">
          <div className="container mx-auto px-6 text-center">
            ...
            <button className="bg-secondary-green text-neutral-white px-6 py-3 rounded-md font-medium shadow-lg hover:shadow-xl transition transform hover:-translate-y-1">Contattaci Ora</button>
          </div>
        </section>
      </div>
    );
