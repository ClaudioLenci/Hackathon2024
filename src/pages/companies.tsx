...
export function Companies() {
    return (
        <div>
            ...
            {/* Sezione piani di pagamento con toolbar */}
            <section className="p-8 md:p-16">
                {/* Toolbar sopra i piani */}
                <div className="flex justify-center bg-light-blue py-4 mb-8">
                    <button className="bg-primary-blue text-white px-6 py-2 rounded-full shadow-md">
                        Per Aziende
                    </button>
                </div>
                ...
                <div className="flex flex-col md:flex-row justify-center gap-8">
                    ...
                    {/* Piano Gold */}
                    <div className="bg-white rounded-lg shadow-md p-6 text-center w-full md:w-1/3 border-4 border-primary-blue relative">
                        <span className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-primary-blue text-white text-sm font-bold px-4 py-1 rounded-full">
                            Il più popolare
                        </span>
