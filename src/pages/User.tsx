...
const User = {
  ...
  certifications: {
      'Ingegneria Informatica': 'Certificato ottenuto al termine del corso di laurea in Ingegneria Informatica presso l\'Università XYZ.',
      'ICDL': 'Certificazione rilasciata da un ente accreditato per l\'uso delle tecnologie informatiche di base.',
      'Hackathon': 'Partecipazione e vittoria nel concorso Hackathon Global 2023.',
      'Cyber Security': 'Certificazione avanzata in Cyber Security rilasciata da CyberSec Organization.',
  },
    ...
    <div className="bg-white rounded-lg p-6 shadow-lg max-w-4xl w-full mx-8">
      ...
      <section className="text-gray-800">
        ...
        <div className="flex flex-col gap-3">
          <CertificationsListing certifications={User.certifications} />
        </div>
      </section>
    </div>
  </div>
